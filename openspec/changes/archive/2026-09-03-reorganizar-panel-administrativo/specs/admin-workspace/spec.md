...
El sistema SHALL presentar a los administradores un menú con las secciones Resumen, Equipos, Certificados, Personas, Importación y Configuración, y SHALL mostrar solamente la sección seleccionada. El menú SHALL NOT incluir destinos de Reportes ni Auditoría.
...
- **THEN** no encuentra Reportes ni Auditoría como destinos de navegación ni como paneles de la pantalla principal
...
El sistema SHALL representar la sección administrativa activa mediante una URL estable y SHALL preservar la navegación esperada del navegador.
